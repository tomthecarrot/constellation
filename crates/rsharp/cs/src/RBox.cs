...
namespace RSharp
{
    ...
    public struct RBox_Float
    {
        [DllImport(Metadata.LIBRARY_NAME)]
        private static extern unsafe float* rsharp__Box_Float__new(float value);
        public static unsafe float* new_(float value)
        {
            return rsharp__Box_Float__new(value);
        }

        [DllImport(Metadata.LIBRARY_NAME)]
        private static extern unsafe void rsharp__Box_Float__drop(float* value);
        public static unsafe void drop(float* value)
        {
            rsharp__Box_Float__drop(value);
        }
    }

    public struct RBox_Double
    {
        [DllImport(Metadata.LIBRARY_NAME)]
        private static extern unsafe double* rsharp__Box_Double__new(double value);
        public static unsafe double* new_(double value)
        {
            return rsharp__Box_Double__new(value);
        }

        [DllImport(Metadata.LIBRARY_NAME)]
        private static extern unsafe void rsharp__Box_Double__drop(double* value);
        public static unsafe void drop(double* value)
        {
            rsharp__Box_Double__drop(value);
        }
    }
}
